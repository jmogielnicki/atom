...
import PinDescription from 'app/common/react/components/growth/unauth/pin/PinDescription/PinDescription';
import { calculatePinDescriptionHeight } from 'app/common/react/components/growth/unauth/pin/PinDescription/PinDescriptionHelpers';
...
const calculatePinMetaHeight = (pin, context, seoUnauthExperiments) => {
  const margin = 10;
  const descriptionHeight = calculatePinDescriptionHeight(pin, context, seoUnauthExperiments);
  const pinAttribution = calculatePinAttributionHeight(pin, true);

  return descriptionHeight + pinAttribution + margin;
};
